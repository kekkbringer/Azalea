...
public:
    ...
    Board() :
	wPawns(0), wKnights(0), wBishops(0), wRooks(0), wQueens(0),
	bPawns(0), bKnights(0), bBishops(0), bRooks(0), bQueens(0),
	wKing(0), bKing(0), white(0), black(0), occ(0)
	{}

    Board(bitb wp, bitb wn, bitb wb, bitb wr, bitb wq, bitb wk,
	  bitb bp, bitb bn, bitb bb, bitb br, bitb bq, bitb bk) :
	wPawns(wp), wKnights(wn), wBishops(wb), wRooks(wr), wQueens(wq),
	bPawns(bp), bKnights(bn), bBishops(bb), bRooks(br), bQueens(bq),
	wKing(wk), bKing(bk),
